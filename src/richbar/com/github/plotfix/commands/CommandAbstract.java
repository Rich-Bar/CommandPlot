...
import net.minecraft.server.v1_9_R1.ExceptionEntityNotFound;
import net.minecraft.server.v1_9_R1.ExceptionInvalidNumber;
...
import net.minecraft.server.v1_9_R1.ICommandDispatcher;
