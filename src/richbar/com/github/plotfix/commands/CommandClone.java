...
import net.minecraft.server.v1_9_R1.StructureBoundingBox;
                ...
                if ((astring.length < 11 || !astring[10].equals("force") && !astring[10].equals("move")) && structureboundingbox.a(structureboundingbox1)) {
                    ...
                    if (structureboundingbox.b >= 0 && structureboundingbox.e < 256 && structureboundingbox1.b >= 0 && structureboundingbox1.e < 256) {
                        ...
                        if (world.a(structureboundingbox) && world.a(structureboundingbox1)) {
                            ...
                            ArrayList<CommandCloneStoredTileEntity> arraylist = Lists.newArrayList();
                            ArrayList<CommandCloneStoredTileEntity> arraylist1 = Lists.newArrayList();
                            ArrayList<CommandCloneStoredTileEntity> arraylist2 = Lists.newArrayList();
                            ...
                            ArrayList<CommandCloneStoredTileEntity> arraylist3 = Lists.newArrayList();

                            arraylist3.addAll(arraylist);
                            arraylist3.addAll(arraylist1);
                            arraylist3.addAll(arraylist2);
                            List<CommandCloneStoredTileEntity> list = Lists.reverse(arraylist3);

                            Iterator<CommandCloneStoredTileEntity> iterator1;
